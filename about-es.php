    ...
    <div class="content_general" id="content_general">
        ...
        <div class="div_content_product" id="div_content_product"  onclick="quitatodo();">
            ...
            <div class="div_productos" id="div_productos">
              <h1 class="h_privacy">¿Quien somos?</h1>
              
              
             <p class="p_conten_cookies">Magos Artesanos es una empresa ubicada en Madrid, EspaÃ±a, especializada en la distribuciÃ³n de productos de magia para el principiante, el aficionado y el profesional.</p><br>

             <p class="p_conten_cookies">Un equipo de personas serias, comprometidas y con altos conocimientos en magia. </p><br><br>

             <p class="p_conten_cookies">Llevan trabajando desde el año 2007 y, actualmente, gracias a este nuevo proyecto europeo en colaboraciÃ³n con Murphys Magic Inc, abren mercado a Europa ofreciendo lo que es, probablemente, el mayor catÃ¡logo de magia del mundo...</p>
             

             <p class="p_conten_cookies">¿Nos acompañas en este viaje?</p>
            </div>
